...
class FasterWhisperSTTService:
    ...
    def transcribe_audio(self, audio_data: bytes, sample_rate: int = 16000) -> str:
        ...
        # Fallback to Google Web API if PyTorch model fails or is unavailable
        try:
