...
# Test respond
res = chat_service.respond("hi")
print(f"RESPOND REPLY: {repr(res.reply)}")

# Test respond_stream
tokens = list(chat_service.respond_stream("hi"))
print(f"RESPOND_STREAM REPLY: {repr(''.join(tokens))}")
