...
Generates Recall@1/3/5, MRR, latency percentiles, category breakdowns, failure analysis,
CSV/JSON/Markdown reports, and visualization plots under evaluation/reports/.
"""
...
def main() -> int:
    ...
    benchmark_engine = RetrievalBenchmark(
        ...
        retriever_pipeline=None if not args.dry_run else benchmark_engine_mock_adapter if False else None,
    )
