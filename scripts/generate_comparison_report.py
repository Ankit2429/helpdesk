...
===============================
Compares pre-fix baseline (71%) vs intermediate (81%) vs final (95%) 100-question audit performance.
"""
...
def generate():
    report_path = ROOT_DIR / "docs" / "retrieval_comparison_report.md"
    content = """# Campus Helpdesk RAG Audit — Comprehensive Before vs After Fixes Comparison Report
